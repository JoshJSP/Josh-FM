...
function boot(){ensureStyle();const overlay=document.getElementById('mairCarWaveOverlay');if(!overlay){setTimeout(boot,100);return}new MutationObserver(()=>queueMicrotask(keepSplit)).observe(overlay,{childList:true,subtree:true});keepSplit()}
