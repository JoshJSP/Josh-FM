...
| H-5 | Circa vijftig permanente timers, waarvan een deel sub-seconde | **Deels.** Vandaag geteld: 66 `setInterval`-aanroepen in runtimecode. `director.js` is de eerste die op `document.hidden` let. Een gedeelde tick-bus is nog niet gebouwd. |
