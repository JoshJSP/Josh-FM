...
window.JFM_RELEASE={version:'2.0.0-beta.6',displayVersion:'2b.0.6',build:'unknown',asset:'73',localCache:'unknown',serverCache:'unknown',updateAvailable:false};
window.JFM_ASSET_VERSION='73';
(()=>{
  ...
  function loadMairUI(){
    ...
    addStyle('mair-station-art-css','./mair-station-art.css?v=73');
    addStyle('mair-request-layer-fix-css','./request-layer-fix.css?v=73');
