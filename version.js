...
window.JFM_RELEASE={version:'2.0.0-beta.6',displayVersion:'2b.0.6',build:'unknown',asset:'59',localCache:'unknown',serverCache:'unknown',updateAvailable:false};
window.JFM_ASSET_VERSION='59';
(()=>{
  ...
  function loadMairUI(){
    ...
    addStyle('mair-station-art-css','./mair-station-art.css?v=59');
