...
window.addEventListener('mair:dj-v2-state',()=>{if(window.MAIRDJ?.version?.startsWith('v3')&&!window.MAIRVoiceEngine?.speaking){setLive(false);status(false)}});
...
window.MAIRDJLiveTruth={version:'mair-dj-live-truth-v1.1',setLive};
})();