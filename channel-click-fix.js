...
(()=>{
  ...
  window.MAIRStationController={version:'mair-station-controller-v3.8-spotify-2026',select:choose,harden:own,buildPool,get switching(){return switching},get channel(){return localStorage.getItem('jfm_music_channel_v1')||'mix'}};window.JFMChannelTapGuard=window.MAIRStationController;
})();