...
const stations={
  ...
  nl:{label:'MAIR NEDERLANDSTALIG',kind:'station',semantic:true,language:'nl',queries:()=>['genre:dutch','dutch pop','nederlandstalig','nederlandse hits']},
  party:{label:'MAIR PARTY',kind:'station',semantic:true,queries:()=>['dance hits','party hits','edm hits','dance pop']},
  chill:{label:'MAIR CHILL',kind:'station',semantic:true,queries:()=>['chill pop','acoustic pop','indie chill','soft pop']},
  summer:{label:'MAIR SUMMER',kind:'station',semantic:true,queries:()=>['summer hits','tropical house','feel good pop','summer pop']}
};
...
window.MAIRStationPolicy={version:'mair-station-policy-v1',stations,get,queries,hardFilter,needsSemantic,label,releaseYear};
})();