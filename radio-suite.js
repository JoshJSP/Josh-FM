...
(()=>{
 ...
 // Load audio guard and playback controllers in a deterministic order.
 ...
 (async()=>{
   try{
     await loadScript('./dj-audio-guard.js?v=1','jfm-dj-audio-guard');
