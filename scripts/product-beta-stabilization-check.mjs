...
const checks=[
  ['MAIR v53 category/diagnostics cache active',sw.includes("mair-v53-category-diagnostics-cleanup-20260815")&&apiVersion.includes("mair-v53-category-diagnostics-cleanup-20260815")],
