...
const checks=[
  ['MAIR v78 reliability release cache active',sw.includes("mair-v78-recovery-diagnostics-20260824")&&apiVersion.includes("mair-v78-recovery-diagnostics-20260824")],
