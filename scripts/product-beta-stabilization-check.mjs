...
const checks=[
  ['MAIR v85 reload device handover cache active',sw.includes("mair-v85-reload-device-handover-20260825")&&apiVersion.includes("mair-v85-reload-device-handover-20260825")],
