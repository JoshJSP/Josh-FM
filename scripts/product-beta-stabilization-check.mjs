...
const checks=[
  ['MAIR v63 playback release cache active',sw.includes("mair-v63-ios-transport-single-owner-20260824")&&apiVersion.includes("mair-v63-ios-transport-single-owner-20260824")],
