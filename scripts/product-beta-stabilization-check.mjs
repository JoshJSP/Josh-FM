...
const checks=[
  ['MAIR v61 consolidated release cache active',sw.includes("mair-v61-release-gate-consolidated-20260816")&&apiVersion.includes("mair-v61-release-gate-consolidated-20260816")],
