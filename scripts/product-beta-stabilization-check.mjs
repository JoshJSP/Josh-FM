...
const checks=[
  ...
  ['DJ v2/background guard loaded at runtime',boot.includes("load('./mair-dj-v2.js','mair-dj-v2')")&&boot.includes("load('./mair-voice-check.js','mair-voice-check-v1')")&&boot.includes("load('./mair-background-guard.js','mair-background-guard-v1')")],
