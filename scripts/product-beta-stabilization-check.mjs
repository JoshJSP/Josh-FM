...
const checks=[
  ['MAIR v88 SDK-confirmed reload cache active',sw.includes("mair-v88-sdk-confirmed-reload-20260825")&&apiVersion.includes("mair-v88-sdk-confirmed-reload-20260825")],
