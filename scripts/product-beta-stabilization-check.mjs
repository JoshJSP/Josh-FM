...
const checks=[
  ['MAIR v84 DJ schedule observability cache active',sw.includes("mair-v84-dj-schedule-observability-20260824")&&apiVersion.includes("mair-v84-dj-schedule-observability-20260824")],
