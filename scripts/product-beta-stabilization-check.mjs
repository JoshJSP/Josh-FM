...
const checks=[
  ['MAIR v76 queue release cache active',sw.includes("mair-v76-request-transition-dedupe-20260824")&&apiVersion.includes("mair-v76-request-transition-dedupe-20260824")],
