...
const checks=[
  ['MAIR v87 atomic reload resume cache active',sw.includes("mair-v87-atomic-reload-resume-20260825")&&apiVersion.includes("mair-v87-atomic-reload-resume-20260825")],
