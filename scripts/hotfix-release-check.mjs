...
const checks=[
 ...
 ['dj-groq-writer',writer.includes('GROQ_API_KEY')&&writer.includes('openai/gpt-oss-120b')&&writer.includes("MAIR_DJ_PROMPT_VERSION='1.1.0'")&&writer.includes('persoonlijke Nederlandse muziekzender')],
