...
expect(dj.includes("phase:'COUNTING'")&&dj.includes("'PREPARING'")&&dj.includes("'ARMED'")&&dj.includes("'HANDOFF'")&&dj.includes("'SPEAKING'")&&dj.includes("'RESTORING'"),'Nieuwe DJ v3.1 state machine is incompleet');
...
expect(easy.includes("live=phase==='SPEAKING'")&&easy.includes("setDjLive(detail.phase==='SPEAKING'"),'DJ LIVE mag alleen zichtbaar zijn tijdens echte spreekfase');
