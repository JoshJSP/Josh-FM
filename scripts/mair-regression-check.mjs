...
expect(dj.includes('const ok=await window.speakText(pack.text,false,{breakId:pack.breakId})')&&dj.includes("setPhase('SPEAKING'")&&!dj.includes('const audio=new Audio()'),'Hoorbare DJ-completion moet via de centrale Voice Engine lopen');
...
expect(sw.includes("const CACHE='mair-v96-personalization-20260826'"),'service-worker cache is niet MAIR v96 personalization');
