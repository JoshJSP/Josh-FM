...
expect(dj.includes("result:lastFailure")&&dj.includes("lastFailure='pause-failed'")&&dj.includes("lastFailure='tts-failed'"),'DJ scheduler mist diagnose voor overgeslagen breaks');
