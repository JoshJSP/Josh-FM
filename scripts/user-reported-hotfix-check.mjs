...
assert.match(easy,/radiomoment komt dichterbij/);assert.match(easy,/luistert mee/);
...
assert.match(version,/mair-sleep\.js/);assert.match(version,/mair-news-bulletin\.js/);assert.match(version,/mair-dj-break-owed-guard\.js/);assert.match(version,/mair-dj-transition-fallback\.js/);assert.match(version,/mair-radio-sequencer\.js/);assert.match(version,new RegExp(`JFM_ASSET_VERSION='${RELEASE_ASSET_VERSION}'`));assert.ok(sw.includes(RELEASE_CACHE),'service-worker cache is niet de huidige release');assert.match(sw,/\.\/mair-sleep\.js/);assert.match(sw,/\.\/mair-dj-break-owed-guard\.js/);assert.match(sw,/\.\/mair-dj-transition-fallback\.js/);assert.match(sw,/\.\/mair-radio-sequencer\.js/);
