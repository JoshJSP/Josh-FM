...
assert.match(version,/mair-sleep\.js/);assert.match(version,/mair-dj-break-owed-guard\.js/);assert.match(version,/JFM_ASSET_VERSION='77'/);assert.match(sw,/mair-v91-sleep-radio-20260825/);assert.match(sw,/\.\/mair-sleep\.js/);assert.match(sw,/\.\/mair-dj-break-owed-guard\.js/);
console.log('MAIR user-reported hotfix gate: PASS — Sleep acoustic songs, half-hour headlines, owed DJ recovery, HITS repeat lock and Spotify rate-limit mitigation');