...
ok(writer.includes('max_completion_tokens:420')&&writer.includes("reasoning_effort:'low'")&&writer.includes('include_reasoning:false')&&writer.includes("MAIR_DJ_PROMPT_VERSION='1.1.0'")&&!writer.includes('max_tokens:220'),'GPT-OSS must use the bounded versioned MAIR DJ prompt contract');
