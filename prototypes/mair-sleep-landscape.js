...
function status(){return{version:'landscape-bedside-2026-08-29-final',enabled,matches:media.matches,applied:lastApplied,sleepAvailable:!!window.MAIRSleep,overlayAvailable:!!overlay()}}
...
window.MAIRSleepLandscapePrototype={version:'landscape-bedside-2026-08-29-final',enable:()=>setEnabled(true),disable:()=>setEnabled(false),sync,status};
})();
