// MAIR authoritative DJ scheduler — one owner for when the DJ talks.
(()=>{
  ...
  const transitionReady=()=>typeof window.JFMDJTransition?.transition==='function';
